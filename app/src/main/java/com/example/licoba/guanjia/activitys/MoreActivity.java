...
import com.example.licoba.guanjia.utils.EncryUtils;
import com.example.licoba.guanjia.utils.FileUtils;
import com.example.licoba.guanjia.utils.SPUtils;
...
//        String backupString = AESUtil.aes(jsonString, key, Cipher.ENCRYPT_MODE);
        ...
        String dir = Environment.getExternalStorageDirectory().getAbsolutePath() + "/出入库管家/";
